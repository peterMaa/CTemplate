...
define([
    ...
    "dojo/topic",
    "esri/urlUtils",
    "../geoplot/activityGeoplot",
    "esri/request",
    "../geoplot/eventPlannerHelper",
    "widgets/locator/locator",
    "dijit/a11yclick",
    "dojo/date/locale"

], function (declare, domConstruct, domStyle, domAttr, lang, on, win, domGeom, dom, array, domClass, Query, Deferred, QueryTask, Point, template, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, sharedNls, topic, urlUtils, ActivityGeoplot, esriRequest, EventPlannerHelper, LocatorTool, a11yclick, locale) {
    // ========================================================================================================================//

    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, ActivityGeoplot, EventPlannerHelper], {
        ...
        */
        postCreate: function () {
            ...
            */
            ...
            this.domNode = domConstruct.create("div", { "title": sharedNls.tooltips.search, "class": "esriCTHeaderGeoplot" }, null);
